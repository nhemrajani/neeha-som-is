...
content/log/         Research log entries in markdown
app/, middleware.ts  Source for a self-hosted version of the log dashboard
```

This repository is public. Anything genuinely confidential stays out of it,
including the log entries under `content/`, which are readable here whatever the
hosted log does.
